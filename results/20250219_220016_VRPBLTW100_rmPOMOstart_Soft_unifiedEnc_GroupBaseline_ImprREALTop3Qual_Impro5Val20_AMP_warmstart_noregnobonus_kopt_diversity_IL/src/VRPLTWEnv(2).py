...
class VRPLTWEnv:
    ...
    def step(self, selected, visit_mask_only =True, out_reward = False, simulation=False, infsb_level=False, return_route=False, safety_layer=None, simulate_and_val=None, use_sl_mask=False):
        ...
        return self.step_state, reward, done, None
