...
def main(rank, world_size, args, env_params, model_params, optimizer_params, trainer_params, tester_params):
    if args.wandb_logger and rank == 0:
        ...
        wandb.init(project="unified_solver", resume="allow", id="e4ejcpdr", name=args.name, config={**env_params, **model_params, **optimizer_params, **trainer_params, **tester_params})
...
if __name__ == "__main__":
    ...
    # load
    parser.add_argument('--checkpoint', type=str, default="/data/jieyi/unified_solver_1/results/20250219_220016_VRPBLTW100_rmPOMOstart_Soft_unifiedEnc_GroupBaseline_ImprREALTop3Qual_Impro5Val20_AMP_warmstart_noregnobonus_kopt_diversity_IL/epoch-1900.pt")
    ...
    log_path = "/data/jieyi/unified_solver_1/results/20250219_220016_VRPBLTW100_rmPOMOstart_Soft_unifiedEnc_GroupBaseline_ImprREALTop3Qual_Impro5Val20_AMP_warmstart_noregnobonus_kopt_diversity_IL"
    ...
    # note = "_TSPTW100Hard_rmPOMOstart_Soft_unifiedEnc_withRNN_GroupBaseline_ImprTop5Qual_Impro5Val20_AMP_noregnobonus_kopt_diversity_IL_PIP"
